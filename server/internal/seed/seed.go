...
func Run(ctx context.Context, pool *pgxpool.Pool) error {
	...
	demo := []demoRow{
		{"Условная винодельня «Станица» (демо)", "compact-wine-1", "winery", 45.058, 38.985,
			...
			[]string{"https://images.unsplash.com/photo-1506377247377-2a5b3b417ebb?w=800"}, ""},
		{"Условная винодельня «Лоза-2» (демо)", "compact-wine-2", "winery", 45.068, 38.998,
			...
			[]string{"дегустация", "демо", "рядом"},
			[]string{"https://images.unsplash.com/photo-1553361371-9b22f78e8b1d?w=800"}, ""},
		{"Условная винодельня «Бочка-3» (демо)", "compact-wine-3", "winery", 45.055, 39.005,
			"Демо: замыкает короткое кольцо.",
			"Условная винодельня.",
			[]string{"музей", "демо", "рядом"},
			[]string{"https://images.unsplash.com/photo-1474722883778-792e7990302f?w=800"}, ""},
		{"Условная винодельня «Рядом-4» (демо)", "compact-wine-4", "winery", 45.062, 39.015,
			...
			[]string{"https://images.unsplash.com/photo-1566995541428-f2246c17cda1?w=800"}, ""},
		{"Гостевой дом «Кластер» (демо)", "compact-hotel", "lodging", 45.060, 38.992,
			...
			[]string{"жильё", "демо"},
			[]string{"https://images.unsplash.com/photo-1566073771259-6a8506099945?w=800"}, ""},
		{"Кафе «Между лозами» (демо)", "compact-food", "food", 45.056, 39.008,
			...
			[]string{"https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=800"}, ""},
		{"Трансфер «Короткий маршрут» (демо)", "compact-transfer", "transfer", 45.059, 38.995,
			...
			[]string{"https://images.unsplash.com/photo-1449965408869-eaa3f722e40d?w=800"}, ""},
	}
	...
	for _, row := range demo {
		...
		_, err := pool.Exec(ctx, `
			...
			) VALUES ($1,$2,$3,$4,$5,'Краснодарский край',$6,$7,$8,$9,$10::jsonb,$11::jsonb,$12,true)
			...
			row.Short, row.Full, tags, photos, vurl)
		if err != nil {
			return err
		}
	}
